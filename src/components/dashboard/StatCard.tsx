...
const StatCard = () => {
    return (
       <div className="w-full flex items-center justify-center flex-row gap-6 px-20">
           {statCardProps.map((prop, key) =>{
               const Icon = prop.icon
               return (
                   <Card key={key} className="w-[286px] h-[134px] pt-6 pb-1">
                       <CardContent>
                           <div className="flex flex-row justify-between">
                           <div className="w-[286px] flex flex-col items-start gap-1">
